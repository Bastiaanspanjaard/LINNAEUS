...
# Dependencies ####
source("./Scripts/LINNAEUS/R_scripts/scar_helper_functions.R")
...
# Colors
larvae.colors <- read.csv("./Scripts/LINNAEUS/Test_data/color_table_larvae.csv",
                          stringsAsFactors = F)
...
# set.seed(1)
# connections <- connections.full[sample.int(nrow(connections.full), 400000), ]

# Plot with cell type labels in figure is commented out since it takes a lot of 
# time.
# png("./Images/2017_10X_10/Larvae_cell_400kconnections_Z4.png",
...
# Plot on tSNE
# png("./Images/2017_10X_2/Larvae_enriched_connections_tsne_Z2_paper.png",
#     width = 8, height = 6, units = "in", res = 300)
# ggplot() +
#   geom_point(data = tsne.coord, size = 0.01,
#              aes(x = tSNE_1, y = tSNE_2, color = Cell.type)) +
