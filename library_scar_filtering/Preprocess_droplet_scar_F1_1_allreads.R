...
# Load data ####
# Scars
scars.in <- read.csv("./Data/2017_10X_10_CR/F1_1_scar_filtered_scars.csv",
...
wt.all.cells <- read.csv("./Data/Larvae_data/Larvae_Seurat_batch_r_out_cells_2.csv",
                        stringsAsFactors = F, sep = ",")
wt.cells <- wt.all.cells[wt.all.cells$Library == "F11", ]
...
all.scars.g1 <- read.table("./Data/2017_10X_10/F1_1_scar_reads_over1.txt",
...
# postscript("./Images/2017_10X_10/F11_cell_type_scar_counts_with_cutoff.eps",
#     width = 7, height = 4.5)
ggplot() +
...
# Write final output ####
# write.csv(scars.output.2, "./Data/2017_10X_10_CR/F1_1_used_scars_7Larvae.csv",
#           row.names = F, quote = F)
# write.csv(maximum.scars, "./Data/2017_10X_10_CR/F1_1_max_scars_7Larvae.csv")
