...
# Load data ####
# Scars
scars.in <- read.csv("./Data/2017_10X_2/scar_3_filtered_scars.csv",
...
wt.all.cells <- read.csv("./Data/Larvae_data/Larvae_Seurat_batch_r_out_cells_2.csv",
                         stringsAsFactors = F, sep = ",")
wt.cells <- wt.all.cells[wt.all.cells$Library == "L3", ]
...
all.scars.g1 <- read.table("./Data/2017_10X_2/scar_3_reads_over1.txt",
...
# write.csv(scars.output, "./Data/2017_10X_2/Z3_preprocessed_scars_allreads_7Larvae.csv",
          # quote = F, row.names = F)

# Undersequencing filter ####
# scars.output <- read.csv("./Data/2017_10X_2/Z3_preprocessed_scars_allreads_7Larvae.csv",
#                          stringsAsFactors = F)
...
# Write final output ####
# write.csv(scars.output.2, "./Data/2017_10X_2/Z3_used_scars_7Larvae.csv",
#           row.names = F, quote = F)
# write.csv(maximum.scars, "./Data/2017_10X_2/Z3_max_scars_7Larvae.csv")
