...
# Load data ####
# Scars
scars.in <- read.csv("./Data/2017_10X_1/scar_filtered_scars.csv",
...
wt.all.cells <- read.csv("./Data/Larvae_data/Larvae_Seurat_batch_r_out_cells.csv",
                        stringsAsFactors = F, sep = ",")
wt.cells <- wt.all.cells[wt.all.cells$Library == "L1", ]
...
all.scars.g1 <- read.table("./Data/2017_10X_1/scar_reads_over1.txt",
...
# Write final output ####
# write.csv(scars.output.2, "./Data/2017_10X_1/Z1_used_scars_7Larvae.csv",
#           row.names = F, quote = F)
# write.csv(maximum.scars, "./Data/2017_10X_1/Z1_max_scars_7Larvae.csv")
