...
# Load data ####
# Scars
scars.in <- read.csv("./Data/2017_10X_10_CR/Z5_scar_filtered_scars.csv",
...
all.scars.g1 <- read.table("./Data/2017_10X_10_CR/Z5_scar_reads_over1.txt",
...
# write.csv(scars.output, "./Data/2017_10X_10_CR/Z5_preprocessed_scars_allreads_7Larvae.csv",
# quote = F, row.names = F)

# Undersequencing filter ####
# scars.output <- read.csv("./Data/2017_10X_10_CR/Z5_preprocessed_scars_allreads_7Larvae.csv",
#                          stringsAsFactors = F)
...
# Write final output ####
# write.csv(scars.output.2, "./Data/2017_10X_10_CR/Z5_used_scars_7Larvae.csv",
#           row.names = F, quote = F)
# write.csv(maximum.scars, "./Data/2017_10X_10_CR/Z5_max_scars_7Larvae.csv")
